...
{
    public struct NetworkWeaponUpgradeOption : INetworkSerializable
    {
        public int WeaponId;
        ...
        public static NetworkWeaponUpgradeOption FromDto(WeaponUpgradeOptionSnapshot dto)
        {
            return new NetworkWeaponUpgradeOption
            {
