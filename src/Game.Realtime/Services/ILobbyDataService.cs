...
{
    Task<string?> CreateAsync(string hostUserId, string playerName, string lobbyName, string gameMode, int maxPlayers, bool isPublic, int stageId = 1, NetworkTopology networkTopology = NetworkTopology.Dedicated);
